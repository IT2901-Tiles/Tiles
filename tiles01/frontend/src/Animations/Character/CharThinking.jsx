            ...
            <svg viewBox="0 0 165 150" className="svgCharacter">
                ...
                <g className="LightBulb">
                    <g className="LightBulbAnimation">
                        <line x1="62" y1="14" x2="55" y2="10" stroke="black" stroke-width="2"/>
                        <line x1="65" y1="9" x2="60" y2="3" stroke="yellow" stroke-width="2"/>
                        <line x1="69" y1="7" x2="68" y2="1" stroke="black" stroke-width="2"/>
                        <line x1="73" y1="8" x2="76" y2="3" stroke="yellow" stroke-width="2"/>
                        <circle cx="70" cy="14" r="5" fill="yellow" stroke="black"/>                    
                        <line x1="84" y1="20.5" x2="75" y2="15" stroke="black" stroke-width="2"/>
                        <animateTransform
                ...
                <line x1="87.5" y1="28" x2="84" y2="20" stroke="black" stroke-width="2"/>
                </g>
               
                    <circle cx="75" cy="50" r="7" stroke="black">
                        <animate
                            attributeName = "r"
                            keyTimes="0;0.5;1"
                            values="7;5;7"
                    ...
                    <circle cx="92" cy="50" r="5" stroke="black">
                        <animate
                            attributeName = "r"
                            keyTimes="0;0.5;1"
                            values="5;7;5"
                ...
                <g className="leftArm"> 
                    ...
                    <rect x="55" y="67" height="16" width="7" fill="grey" stroke="black" transform="rotate(-120 55 89.5)"/>
                    <circle cx="28" cy="101" r="5" fill="grey" stroke="black" />
                    <rect x="24" y="78" height="16" width="6.5" fill="grey" stroke="black" transform="rotate(18 28 101)"/>
                    <rect x="30" y="62" height="14" width="5" fill="grey" stroke="black" transform="rotate(-10 32.5 68.5)"/>
                    <rect x="39" y="62" height="14" width="5" fill="grey" stroke="black" transform="rotate(30 39.5 68.5)"/>
                    <animateTransform
                        attributeName = "transform"
                        attributeType = "XML"
                        type = "rotate"
