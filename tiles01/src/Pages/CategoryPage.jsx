    ...
    return (
        <div className="Page">
            ...
            <div className="CardContainer">
                ...
                <LinkButton target="/cards" title="Choose" size="Small" category={props.location.state.category} card={Card} active={cardSelected} buttonError={"Please select a card"} ></LinkButton>
            </div>
