        ...
        <div>
            ...
            <svg height="400" width="300">
                <g>
                    ...
                    <g>
                        {/* <line id="pen1" x1="80" y1="260" x2="190" y2="140" stroke="#000000" strokeWidth="25" >
                            <animate
                                attributeName="stroke"
                                values="black;green;red;black"
                                dur="8s"
                                repeatCount="indefinite" />
                        </line>
                        <line id="pen2" x1="195" y1="134.5" x2="208" y2="120.5" stroke="#000000" strokeWidth="25" >
                            <animate
                                attributeName="stroke"
                                values="black;green;red;black"
                                dur="8s"
                        ...
                        <polygon id="pen3" points="64.5,258.5 83,276 50,292" fill="#000000">
                            <animate
                                attributeName="fill"
                                values="black;green;red;black"
                                dur="8s"
